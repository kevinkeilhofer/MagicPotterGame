...
import timeOverscreen from "./timeOver.js";
import congratulations from "./congratulations.js";

(async () => {
  // make sure to load all webfonts first
  await webfonts(["Harry P", "Raleway:700"]);
...
function startup() {
  ...
  // timeOver ('t', 'Control'); nur als Test, sollte erscheinen, wenn die Zeit abgelaufen ist
  timeOverscreen("t");

  // menuscreen('m', 'Button');
  menuscreen("m");

  // congratulation ('c', 'Button'); nur als Test, sollte erscheinen, wenn alle Bohnen eingesammelt wurden
  congratulations("c");
